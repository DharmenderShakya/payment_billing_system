...
PreparedStatement ps=con.prepareStatement("select * from payregister where branch='"+branch+"' and username like '%"+n+"%' or ID like '%"+n+"%' or DATEOFBIRTH like '%"+n+"%' or DATEOFJOINING like '%"+n+"%'");
//ps.setString(1,n);
out.print("<br>");
